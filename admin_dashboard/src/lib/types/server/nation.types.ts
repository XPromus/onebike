...
export type PageGetNationDto = components["schemas"]["PageGetNationDto"];
export type GetNationWithChildrenDto = components["schemas"]["GetNationWithChildrenDto"];
export type PageGetNationWithChildrenDto = components["schemas"]["PageGetNationWithChildrenDto"];
